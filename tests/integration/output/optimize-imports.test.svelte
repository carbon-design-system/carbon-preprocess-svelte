...
import Add20 from "carbon-icons-svelte/lib/Add20/Add20.svelte";
  ...
  import Bridge from "carbon-pictograms-svelte/lib/Bridge.svelte";
import Item from "carbon-pictograms-svelte/lib/Item.svelte";
  import Berlin from "carbon-pictograms-svelte/lib/Berlin.svelte";
</script>
