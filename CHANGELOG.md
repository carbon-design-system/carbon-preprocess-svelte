...
- `optimizeCss`: invert BEM allowlist matching
...
- re-index exports using `carbon-components-svelte@0.111.1`

## [0.11.40](https://github.com/carbon-design-system/carbon-preprocess-svelte/releases/tag/v0.11.40) - 2026-08-15

**Performance**

- `indexer`: cache resolved module paths in runtime-class graph (~10% faster runtime-class phase)
- `indexer`: cut redundant selector work in CSS context extraction (~38% faster CSS-context phase)
- `optimizeCss`: compile allowlist to a single regex in default mode (~5-15% faster)
- `optimizeCss`: cut strict-mode selector matching overhead (~27% faster)
- `optimizeImports`: scan top-level imports directly (~15-20% faster)

## [0.11.39](https://github.com/carbon-design-system/carbon-preprocess-svelte/releases/tag/v0.11.39) - 2026-08-14

**Fixes**

- re-index exports using `carbon-components-svelte@0.111.0`
- `indexer`: honor `carbonRoot` in CSS path resolution

## [0.11.38](https://github.com/carbon-design-system/carbon-preprocess-svelte/releases/tag/v0.11.38) - 2026-07-21

**Features**

- bundle published `.d.ts` into a single entry file to reduce bundle size

**Fixes**

- re-index exports using `carbon-components-svelte@0.110.1`

## [0.11.37](https://github.com/carbon-design-system/carbon-preprocess-svelte/releases/tag/v0.11.37) - 2026-06-30

**Features**

- `optimizeCss`: add `experimental.liveIndex` to dynamically build the component index
- `optimizeCss`: add safelist and content escape hatches

**Fixes**

- `index-components`: make sub-component class merge order-independent
- `optimizeImports`: preserve type-only barrel imports

**Performance**

- `optimizeImports`: skip parse for files without carbon- imports
...
- `optimizeCss`: automate runtime and CSS context classes
- `optimizeCss`: exempt context ancestors in strict selectors

## [0.11.33](https://github.com/carbon-design-system/carbon-preprocess-svelte/releases/tag/v0.11.33) - 2026-06-06

**Fixes**

- `optimizeCss`: improve strict mode optimizer by ~0.3%
...
- `optimizeCss`: add `experimental.strict` strategy
- re-index exports using `carbon-components-svelte@0.108.0`

## [0.11.30](https://github.com/carbon-design-system/carbon-preprocess-svelte/releases/tag/v0.11.30) - 2026-04-12

**Fixes**

- re-index exports using `carbon-components-svelte@0.106.0`

## [0.11.29](https://github.com/carbon-design-system/carbon-preprocess-svelte/releases/tag/v0.11.29) - 2026-03-30

**Fixes**

- re-index exports using `carbon-components-svelte@0.105.0`

## [0.11.28](https://github.com/carbon-design-system/carbon-preprocess-svelte/releases/tag/v0.11.28) - 2026-03-12

**Fixes**

- re-index exports using `carbon-components-svelte@0.103.0`
- `optimizeCss`: pass PostCSS `from` option to silence "Without from option" warning
